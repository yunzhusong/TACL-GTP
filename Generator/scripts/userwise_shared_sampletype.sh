...
#model_name_or_path="bart_news_bart_input_pred_A_extra_online_A_userize_average_mum_loss_v4/checkpoint-8000"
#model_name_or_path="bart_input_pred_A_extra_online_A_userize_tailfeat_mum_dot_loss_v4/checkpoint-8000"
#model_name_or_path="bart_input_pred_A_extra_online_A_userize_average_v4/checkpoint-8000"
...
userize_loss=false
userize_pum=false
userize_ctr_threshold=275 #37 #215 #275 #930
...
for ((userwise_index=0; userwise_index<=102; userwise_index++));
do
